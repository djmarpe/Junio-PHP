...
<html>
    ...
    <body class="background-dark-blue">
        ...
        $usuarioAmigo = $_SESSION['usuarioElegido'];
        ?>
        <div class="row m-3">
            ...
            <div class="col-12 bg-white">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb my-2">
                        ...
                        ?>
                        <li class = "breadcrumb-item" aria-current = "page"><a href = "../controladores/controlador.php?verAmigos=verAmigos" class = "text-decoration-underline text-dark">Ver amigos</a></li>
                        <li class="breadcrumb-item active" aria-current="page"><?= $usuarioAmigo->getNombreUsuario() . ' ' . $usuarioAmigo->getApellidosUsuario() ?></li>
                    </ol>
                </nav>
            </div>
        </div>
        ...
        <div class="row m-3">
            <div class="col-12 bg-white">
                <input type="hidden" name="nombre" value="<?= $usuarioAmigo->getNombreUsuario() ?>">
                <input type="hidden" name="apellido" value="<?= $usuarioAmigo->getApellidosUsuario() ?>">
                <?php
                ...
                <h3 class="my-5 text-decoration-underline text-center"><?= $usuarioAmigo->getNombreUsuario() . ' ' . $usuarioAmigo->getApellidosUsuario() ?></h3>
                <div class="row m-0">
                    <div class="col-12 col-sm-6">
                        <p><?= $usuarioAmigo->getDescripcion() ?></p>
                    </div>
                    <div class="col-12 col-sm-6">
                        <div class="row m-0">
                            <div class="col-12 col-sm-6 my-3">
                                <strong>País:</strong>
                                <input type="hidden" id="pais" value="<?= $usuarioAmigo->getPais() ?>">
                                <small><?= $usuarioAmigo->getPais() ?></small>
                            </div>
                            <div class="col-12 col-sm-6 my-3">
                                <strong>Localidad:</strong>
                                <input type="hidden" id="localidad" value="<?= $usuarioAmigo->getLocalidad() ?>">
                                <small><?= $usuarioAmigo->getLocalidad() ?></small>
                            </div>
                            <div class="col-12 col-sm-6 my-3">
                                <strong>Fecha de nacimiento:</strong>
                                <input type="hidden" id="fechaNac" value="<?= $usuarioAmigo->getFechaNacimientoUsuario() ?>">
                                <small><?= $usuarioAmigo->getFechaNacimientoUsuario() ?></small>
                            </div>
                            <div class="col-12 col-sm-6 my-3">
                                <strong>Correo electrónico:</strong>
                                <input type="hidden" id="emailMatch" value="<?= $usuarioAmigo->getEmail() ?>">
                                <input type="hidden" id="emailUsuario" value="<?= $usuarioAmigo->getEmail() ?>">
                                <small><?= $usuarioAmigo->getEmail() ?></small>
                            </div>
                            <div class="col-12 my-3">
                                <h5 class="m-0 text-center">Preferencias de tu amigo</h5>
                            </div>
                            <?php
                            $preferenciasUsuario = $usuarioAmigo->getPreferencias();
                ...
                <div class="row m-0">
                    <form action="../controladores/controlador.php" method="POST" class="col-12 my-3 text-center">
                        <input type="hidden" id="idUsuario" name="idUsuario" value="<?= $usuarioAmigo->getIdUsuario() ?>">
                        <input type="submit" name="borrarAmigo" value="Borrar amigo" class="btn btn-primary">
                                    ...
                                    <div class="modal-body">
                                        <form action="../controladores/controlador.php" method="POST" enctype="multipart/form-data">
                                            ...
                                            <div class="my-2">
                                                ...
                                                <input type="hidden" name="idUsuarioEmisor" value="<?= $usuarioAmigo->getIdUsuario() ?>">
